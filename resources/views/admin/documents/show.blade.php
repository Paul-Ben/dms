    ...
    <div class="container-fluid pt-3 pt-md-4 px-2 px-md-3">
        <div class="bg-light rounded p-3 p-md-4">
            <div class="email-container">
                ...
                <!-- Split Layout: Current Document (left) | Previous Minuting (right) -->
                <div class="doc-split mt-3">
                    ...
                    <section class="doc-panel panel-left" aria-label="Current Document">
                        ...
                        <div class="panel-body" id="leftPanelBody">
                            ...
                            <div class="p-2 border-top bg-light sticky-actions" aria-label="Document actions">
                                @if ($document_received->attachments->isNotEmpty())
                                    <a href="{{ $document_received->attachments[0]->attachment }}" target="__blank" class="btn btn-sm btn-outline-primary">
                    ...
                    <section class="doc-panel panel-right" aria-label="Previous Minuting">
                        <header class="panel-header d-flex align-items-center justify-content-between">
                            ...
                            {{-- <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label small" for="syncScroll">Click to view minuting</label>
                            </div> --}}
                        </header>
            ...
            <div id="minutingSection" class="card mt-4 d-none">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <small class="text-muted">Note: Minuting is end to end encrypted.</small>
                </div>
                <div class="card-body">
